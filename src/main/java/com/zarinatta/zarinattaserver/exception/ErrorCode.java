...
public enum ErrorCode {
    ...
    BOOKMARK_PERMISSION_DENIED("B-002", HttpStatus.UNAUTHORIZED, "BOOKMARK_PERMISSION_DENIED"),

    // 404
    USER_NOT_FOUND("U-001", HttpStatus.NOT_FOUND, "USER_NOT_FOUND"),
    BOOKMARK_NOT_FOUND("B-001", HttpStatus.NOT_FOUND, "BOOKMARK_NOT_FOUND"),
    TICKET_NOT_FOUND("T-001", HttpStatus.NOT_FOUND, "TICKET_NOT_FOUND"),
